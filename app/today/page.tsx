...
// ============================================================================
// CONTRAST PAIRS (same pool as homepage)
// ============================================================================
...
function BreathingDot({ color, delay = 0 }: { color: string; delay?: number }) {
  return (
    <div
...
function StatCard({ 
  ...
  return (
    ...
    >
      <BreathingDot color={color} delay={index * 0.5} />
      <Icon 
...
function ContrastCard({ 
  ...
  return (
    <div
      className="flex flex-col items-center justify-center rounded-2xl px-6 py-8 w-full"
      style={{
        background: "rgba(255,255,255,0.03)",
