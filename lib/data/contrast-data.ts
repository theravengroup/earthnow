...
export const CONTRAST_DATA: ContrastEntry[] = [
  ...
  { pool: "A", stat1: "250 people will turn 18 today.", stat2: "145 will turn 65.", voice: "The planet is getting younger and older at the same time." },
  // Pool B - Environment
  { pool: "B", stat1: "13 hectares of forest were lost today.", stat2: "348 trees were planted.", voice: "We're not keeping up." },
  ...
  { pool: "B", stat1: "180 tonnes of fish were pulled from the ocean this hour.", stat2: "20 tonnes of plastic went in.", voice: "The ocean remembers both." },
  { pool: "B", stat1: "2.5 million tonnes of ice will melt today.", stat2: "That ice took thousands of years to form.", voice: "We're spending what we can't earn back." },
  { pool: "B", stat1: "142,700 tonnes of topsoil eroded today.", stat2: "It takes nature 500 years to generate one inch.", voice: "We're farming on borrowed time." },
  ...
  { pool: "D", stat1: "231 million emails will be sent today.", stat2: "1,000 people will call a mental health crisis line.", voice: "We're more connected and more alone than ever." },
  { pool: "D", stat1: "6.9 million AI queries will run today.", stat2: "17 people will die of hunger today.", voice: "The intelligence is artificial. The suffering isn't." },
  { pool: "D", stat1: "3.3 million photos will be taken in the next minute.", stat2: "13 hectares of forest will be lost.", voice: "We're documenting a world we're dismantling." },
  { pool: "D", stat1: "Humanity will spend 8.3 million hours online today.", stat2: "And 1.7 million hours of sleep will be lost.", voice: "We traded rest for the scroll." },
  ...
  { pool: "D", stat1: "1 person will die by suicide in the next minute.", stat2: "1,000 will call a crisis line today.", voice: "Some of them won't." },
  ...
  { pool: "E", stat1: "Humanity will work 44.4 million hours today.", stat2: "And spend 8.3 million hours scrolling.", voice: "We know which one we'll remember." },
  ...
  { pool: "F", stat1: "1.7 million hours of sleep will be lost tonight.", stat2: "Productivity culture will call that dedication.", voice: "Your body calls it something else." },
  ...
  { pool: "F", stat1: "1,000 people will call a mental health crisis line today.", stat2: "Mental health funding is less than 2% of global health spending.", voice: "We built a world that breaks people, then underfunded the repair shop." },
];
