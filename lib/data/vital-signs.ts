...
export const vitalSignsRow1: MetricConfig[] = [
  ...
  { color: "#768a9e", label: "People Ever Lived", ratePerSecond: 2.6, useAbbreviated: true, baseValue: 117_000_000_000 },
...
export const vitalSignsRow2: MetricConfig[] = [
  ...
  { color: "#768a9e", label: "Wildlife Animals Killed Today", ratePerSecond: 3000000000 / 86400, useAbbreviated: true },
...
export const vitalSignsRow3: MetricConfig[] = [
  ...
  { color: "#768a9e", label: "Air Pollution Deaths Today", ratePerSecond: 19178 / 86400, useAbbreviated: false },
...
export const vitalSignsRow4: MetricConfig[] = [
  ...
  { color: "#768a9e", label: "Plastic Produced Today (tonnes)", ratePerSecond: 1000000 / 86400, useAbbreviated: false },
...
export const vitalSignsRow5: MetricConfig[] = [
  ...
  { color: "#768a9e", label: "Satellite Signals Transmitted Today", ratePerSecond: 1000000000000 / 86400, useAbbreviated: true },
