...
export const heroTickerPairings: HeroTickerPairing[] = [
  { left: { label: "MEALS WASTED TODAY", dailyTotal: 3300000, color: "#f43f5e", icon: "Utensils" }, right: { label: "HUNGER DEATHS TODAY", dailyTotal: 25000, color: "#f97316", icon: "Skull" } },
  { left: { label: "MILITARY SPENDING TODAY ($)", dailyTotal: 6300000000, color: "#ef4444", icon: "Shield" }, right: { label: "HUNGER DEATHS TODAY", dailyTotal: 25000, color: "#f97316", icon: "Skull" } },
  ...
  { left: { label: "CIGARETTES SMOKED TODAY", dailyTotal: 15000000000, color: "#a855f7", icon: "Flame" }, right: { label: "CANCER DEATHS TODAY", dailyTotal: 27000, color: "#ef4444", icon: "Skull" } },
  ...
  { left: { label: "PLASTIC PRODUCED TODAY (TONNES)", dailyTotal: 1000000, color: "#768a9e", icon: "Package" }, right: { label: "OCEAN FISH CAUGHT TODAY (TONNES)", dailyTotal: 260000, color: "#06b6d4", icon: "Fish" } },
  ...
  { left: { label: "AI QUERIES TODAY", dailyTotal: 10000000000, color: "#8b5cf6", icon: "Cpu" }, right: { label: "SUICIDES TODAY", dailyTotal: 2200, color: "#6366f1", icon: "AlertTriangle" } },
  ...
  { left: { label: "SMARTPHONES SOLD TODAY", dailyTotal: 3800000, color: "#8b5cf6", icon: "Smartphone" }, right: { label: "TONS OF E-WASTE CREATED TODAY", dailyTotal: 180000, color: "#768a9e", icon: "Trash2" } },
